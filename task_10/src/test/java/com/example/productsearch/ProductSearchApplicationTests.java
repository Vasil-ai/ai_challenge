...
public class ProductSearchApplicationTests {
    ...
    void testCategoryFilter() {
        var filter = ProductFilter.of("Fitness", null, null, null, null, null, null, null, null);
    ...
    void testPriceMinFilter() {
        var filter = ProductFilter.of(null, 120.0, "min", null, null, null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
        assertEquals(3, result.size());
    ...
    void testPriceMaxFilter() {
        var filter = ProductFilter.of(null, 120.0, "max", null, null, null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
    ...
    void testPriceEqualsFilter() {
        var filter = ProductFilter.of(null, 100.0, "equals", null, null, null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
    ...
    void testRatingMinFilter() {
        var filter = ProductFilter.of(null, null, null, 4.7, "min", null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
        assertEquals(2, result.size());
    ...
    void testRatingMaxFilter() {
        var filter = ProductFilter.of(null, null, null, 4.5, "max", null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
        assertEquals(2, result.size());
    ...
    void testRatingEqualsFilter() {
        var filter = ProductFilter.of(null, null, null, 4.2, "equals", null, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
        assertEquals(1, result.size());
    ...
    void testInStockFilter() {
        var filter = ProductFilter.of(null, null, null, null, null, true, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
    ...
    void testCombinedFilters() {
        var filter = ProductFilter.of("Fitness", 120.0, "min", 4.5, "min", true, null, null, null);
        var result = ProductSearchApplication.filterProductsStrict(products, filter);
